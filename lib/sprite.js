...
module.exports = function (opts) {
    ...
    return {
        ...
        update: function () {
            // Update any collision handlers for this sprite.
            opts.collisions.forEach(function (handler) {
                handler.update(this);
            });
            // Update the graphics.
            opts.strip.update();
        ...
        draw: function (ctx) {
            opts.strip.draw(ctx, this.pos.x, this.pos.y, this.scale, this.rotation);
        },
        mask: opts.mask,
        move: function (x, y) {
            this.pos.x = x;
        ...
        intersects: function (other) {
            return opts.mask.intersects(other.mask);
        },
